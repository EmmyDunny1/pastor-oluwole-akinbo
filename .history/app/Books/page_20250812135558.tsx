...
export default function PrelaunchHero() {
  return (
    <section suppressHydrationWarning className="relative isolate overflow-hidden bg-[linear-gradient(90deg,#171717_0%,#2a0b44_30%,#7b1fa2_60%,#ff6a00_100%)] text-white">
      {/* Particles (CSS-only) */}
