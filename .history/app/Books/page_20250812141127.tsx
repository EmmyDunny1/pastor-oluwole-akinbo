...
const BooksSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#171717] via-gray-800 to-black text-white overflow-hidden">
      {/* Background Glow */}
      <div className="absolute inset-0">
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-gray-700/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-[30rem] h-[30rem] bg-gray-600/20 rounded-full blur-3xl animate-pulse"></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-shrink-0">
            <img
              src="/author.jpg"
              alt="Author"
              className="w-[380px] h-[420px] object-cover rounded-2xl shadow-2xl border-4 border-gray-700"
            />
          </div>
        </div>

        {/* PRELAUNCH BOOK SECTION */}
        <div className="flex flex-col lg:flex-row items-center gap-12 bg-gradient-to-br from-gray-900/80 to-gray-800/60 rounded-2xl shadow-lg border border-gray-700/50 p-8">
          {/* Left Text */}
          <div className="flex-1">
            ...
            <button className="flex items-center gap-3 bg-white text-[#171717] hover:bg-gray-300 px-6 py-3 rounded-full font-semibold transition-all duration-300 group">
              Pre-order Now
          ...
          <div className="flex-shrink-0">
            <img
              ...
              className="w-[320px] h-[420px] object-cover rounded-lg transition-transform duration-500 hover:scale-105"
            />
          </div>
        </div>
