...
const EVENT = {
  ...
  // Local time in Africa/Lagos
  startLocalISO: "2025-08-30T10:00:00+01:00", // From flier: Saturday, 30th August 2025 — 10:00 AM
  endLocalISO:   "2025-08-30T13:00:00+01:00", // Estimated 3 hours end time
  venueName: "His Coming Evangelical Church Int'l Inc.",
  addressLine: "No. 6 Adekunle Street, College Crescent, Molete, Ibadan, Oyo State, Nigeria",
  addressExtra: "",
  details:
    "Join family, friends and the church as we celebrate the retirement of Pastor Samuel Oluwole Akinbo — a life of faith, love, and impact.",
};
      ...
      <section className="px-6 py-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="w-full relative flex justify-center">
            ...
            <div className="p-4 bg-white rounded-3xl shadow-2xl border-4 border-[#003366] relative z-10 w-full max-w-[200px]">
              <div className="relative w-full h-[720px] sm:h-[500px]">
                {/* Flier */}
                <Image
                  src="/others/Retirement.jpg"
