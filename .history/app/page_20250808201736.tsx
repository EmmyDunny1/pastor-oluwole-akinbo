...
<div> <section className="max-w-4xl mx-auto text-center py-16 px-4">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4">
        <Link href="/SubmitTestimony" className="bg-gray-100  text-gray-950 border-gray-100 border-1  text-white px-6 py-3 rounded font-semibold">Share a Testimony</Link>
        <Link href="/Gift" className=" border-gray-100 border-1  text-white px-6 py-3 rounded font-semibold">Send a Gift</Link>
      </div>
    </section></div>
    <TestimonyForm />
