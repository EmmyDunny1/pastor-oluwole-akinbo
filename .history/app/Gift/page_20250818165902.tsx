...
export default function Payment() {
  ...
  <Link className="block bg-white p-4 rounded mt-4 text-center  leading-0.5 text-[11px] font-bold" href="/AccountNumTransfer"><p className="text-center text-2xl text-green-700 leading-0.5 text-[11px] font-bold">
