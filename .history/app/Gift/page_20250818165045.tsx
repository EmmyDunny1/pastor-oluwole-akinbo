  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 py-10 px-4">
      ...
      <div className="max-w-2xl text-center mb-10">
        <h2 className="text-3xl sm:text-4xl font-bold text-blue-700 dark:text-blue-300 mb-4">
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="mt-[-8px] border-[0.5px] p-2 border-blue-200">
            <span className="text-center text-blue-200 leading-0.5 text-[11px] font-bold">
              Note: If you are using bank transfer, the account number generated is temporary and expires after 30 minutes.
            </span>

           
          </div>
  <Link className="block bg-white p-4 rounded mt-4 text-center text-gray-950 dark:text-gray-400 leading-0.5 text-[11px] font-bold" href="/AccountNumTransfer"><p className="text-center text-gray-500 dark:text-gray-400 leading-0.5 text-[11px] font-bold">
              To Make Payment Without Card, Click To View Account Number
            </p>
            </Link>
          <div>
