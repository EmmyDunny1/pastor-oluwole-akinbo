...
export default function Payment() {
  ...
  <Link className="block bg-white p-4 rounded mt-4 text-center font-bold" 
  href="/DirectTransfer"><p className="text-center text-green-950 leading-0.5 text-[11px] font-bold flex-">
