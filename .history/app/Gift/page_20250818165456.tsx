...
export default function Payment() {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 py-10 px-4">
      ...
      <div className="max-w-2xl text-center mb-10">
        <h2 className="text-3xl sm:text-4xl font-bold text-green-700 dark:text-blue-300 mb-4">
  ...
  <Link className="block bg-white p-4 rounded mt-4 text-center  leading-0.5 text-[11px] font-bold" href="/AccountNumTransfer"><p className="text-center text-2xl text-green-950 leading-0.5 text-[11px] font-bold">
