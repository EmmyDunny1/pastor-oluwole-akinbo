...
import { BudPayButton, BudPayConfig } from "@budpay/react";
...
export default function Payment() {
  ...
  const config: BudPayConfig = {
    api_key: process.env.NEXT_PUBLIC_BUDPAY_PUBLIC_KEY || "", // Your public key
    amount: Number(form.amount) * 100, // BudPay expects in kobo
    currency: "NGN",
