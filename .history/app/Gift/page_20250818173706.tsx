...
export default function Payment() {
  ...
  <Link className="block mt-4 text-center text-[11px] uppercase font-bold" 
  href="/DirectTransfer"> For Direct Payment Without Card
    <p className="text-center text-green-950 leading-0.5 text-[11px]  bg-white rounded font-bold p-4 flex-">
