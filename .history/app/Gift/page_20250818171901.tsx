...
export default function Payment() {
  ...
  href="/DirectTransfer"><p className="text-center text-2xl text-green-950 leading-0.5 text-[11px] font-bold">
              For Direct Payment Without Card, Click For Account Number
            </p>
            </Link>
          <div>
