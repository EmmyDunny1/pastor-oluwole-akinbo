...
export default function Payment() {
  ...
  const buttonConfig = {
    ...
    text: "Proceed to Pay",
    className:
      "w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded-md transition focus:outline-none focus:ring-2 focus:ring-gree-400 disabled:opacity-60",
  };
