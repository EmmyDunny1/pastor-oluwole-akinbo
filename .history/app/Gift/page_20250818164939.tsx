...
export default function Payment() {
  ...
  <Link className="block border- mt-4 text-center text-gray-500 dark:text-gray-400 leading-0.5 text-[11px] font-bold" href="/AccountNumTransfer"><p className="text-center text-gray-500 dark:text-gray-400 leading-0.5 text-[11px] font-bold">
