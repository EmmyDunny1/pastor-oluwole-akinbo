...
export default function Payment() {
  ...
  <Link href="/AccountNumTransfer"><p className="text-center text-gray-500 dark:text-gray-400 leading-0.5 text-[11px] font-bold">
              Please ensure to complete your payment within the stipulated time.
            </p>
            </Link>
          <div>
