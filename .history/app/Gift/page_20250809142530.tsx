    ...
    <div className="min-h-[70vh] flex items-center justify-center bg-gray-100 dark:bg-gray-900 py-10 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <span className=" text-red-600 text-[12px]  font-light">Note: If you are using bank transfer, account number generated for you is temporary and cannot be used after 30mins. </span>
        </form>
      </div>
    </div>
  );
