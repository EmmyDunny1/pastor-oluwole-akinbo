      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        >
          ...
          <input
            ...
            onChange={handleChange}
            required
            className="w-full border px-4 py-2 rounded-md dark:bg-gray-700 dark:text-white font-light"
          />
          ...
          <div className="mt-[-8px] border-[0.5px] p-2 border-blue-200">
            <span className="text-center text-blue-200 leading-0.5 text-[11px] bg-gray font-bold justify-center">
              Note: If you are using bank transfer, account number generated for
              you is temporary and cannot be used after 30mins.
            </span>
          </div>
        </form>
      </div>
