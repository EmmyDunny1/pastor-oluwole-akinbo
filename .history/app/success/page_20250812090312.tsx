    ...
    <div className="p-6 text-center">
      ...
      {details && (
        <div className="mt-4 text-left inline-block bg-gray-100 p-4 rounded-lg text-black">
          ...
          <Link className="text-white  p-1 hover:underline bg-gray-800 " href="/">Go back to home</Link>
        </div>
        
)
      
      && (
        <><div><Link className="text-white  p-1 hover:underline bg-gray-800 " href="/">Go back to home</Link></div></>
      )
