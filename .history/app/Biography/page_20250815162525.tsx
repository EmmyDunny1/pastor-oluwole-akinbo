    ...
    <div className={`${inter.className} bg-gray-50 text-gray-900`}>
      ...
      <section className="relative bg-gray-900 text-white py-16">
        <div className="max-w-5xl mx-auto px-6 text-center md:text-left md:flex md:items-center md:gap-8">
          ...
          {/* Heading and subtext */}
          <div>
            <h1 className={`${quicksand.className} text-3xl md:text-5xl font-extrabold mb-4 md:text-left`}>
              Biography <span className=" font-extralight text-md text-gray-400"> of</span>  Pst  SAMUEL OLUWOLE AKINBO
            </h1>
...
o	He also undertook computer training in 2014 and obtained a Certificate in Desktop Publishing. <br />
    ...
    <Link
              href="/Books"
              className="inline-block bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 mt-5  font-semibold shadow-lg transition"
            >
            View Books →
            </Link>
            ...
            <p className="text-lg text-justify leading-relaxed">
          •	He was awarded the Recognition Award of Excellence in 2013 during the Merit Award of Lagos State Government State Universal Basic Education Board, Ifako Ijaiye Local Government Authority. <br />
          •	In 2014, he received the Annual Award for Recognition of Excellence as Most Outstanding S.B.M.C. Chairman for his contribution to Education Development. <br />
          •	In 2016, he and his wife, Evang. Mrs. Sola Akinbo, received the AWARD of EXCELLENCE from 'The Generation of Joshua' H. C. E. C., Lagos Zone. 
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8].map((img) => (
              ...
              >
                <Image
                  ...
                  width={500}
                  height={350}
                  className="w-full h-48 object-cover object-top transform group-hover:scale-110 transition duration-500"
                />
              </div>
            ))}
          </div>
