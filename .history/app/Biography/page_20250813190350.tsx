...
o	He also undertook computer training in 2014 and obtained a Certificate in Desktop Publishing. <br />
    ...
    <Link
            ...
            <p className="text-lg text-justify leading-relaxed">
          	He was awarded the Recognition Award of Excellence in 2013 during the Merit Award of Lagos State Government State Universal Basic Education Board, Ifako Ijaiye Local Government Authority. 
