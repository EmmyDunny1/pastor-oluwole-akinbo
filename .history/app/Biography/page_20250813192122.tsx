    ...
    <div className={`${inter.className} bg-gray-50 text-gray-900`}>
      ...
      <section className="relative bg-gray-900 text-white py-16">
        <div className="max-w-5xl mx-auto px-6 text-center md:text-left md:flex md:items-center md:gap-8">
          ...
          {/* Heading and subtext */}
          <div>
            <h1 className={`${quicksand.className} text-3xl md:text-5xl font-extrabold mb-4`}>
              Biography <span className=" font-extralight text-sm text-gray-400"> of</span>  Pst  SAMUEL OLUWOLE AKINBO
            </h1>
            <p className="text-lg md:text-xl fontopacity-90">
