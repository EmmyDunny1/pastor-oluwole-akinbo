...
export default function HeroPage() {
  return (
    <div className="min-h-screen bg-gray-800 flex items-center justify-center">
      <div className="w-full px-4 py-8 sm:py-12 md:py-16 flex flex-col md:flex-row items-center">
        {/* Text Content */}
        <motion.div
          className="w-full md:w-1/2 text-center md:text-left mb-6 sm:mb-8 md:mb-0"
          initial="hidden"
          animate="visible"
        ...
        >
          <div className="relative w-full h-[250px] sm:h-[300px] md:h-[400px] lg:w-[600px] lg:h-[450px] bg-[#171717] rounded-lg overflow-hidden shadow-lg">
            <img
              src="public/others/BooksImage.jpg" // Use this if the image is named Hero.jpg
              // src="/others/Img1.jpg" // Uncomment this if the image is named Img1.jpg
