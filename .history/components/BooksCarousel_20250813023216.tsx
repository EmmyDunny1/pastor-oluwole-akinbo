          ...
          {nonPre.map((book) => (
            ...
            >
              ...
              <div className="w-full lg:w-[75%] flex flex-col items-center">
                ...
                <a
                  href={book.link}
                  className="mt-4 inline-flex items-center gap-3 bg-white text-[#171717] font-semibold px-5 py-3 rounded-fullshadow-md hover:shadow-lg transition-all duration-300 group"
                >
                  Order Now
