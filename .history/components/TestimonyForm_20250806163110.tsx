    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <label htmlFor="video-upload" className="flex items-center gap-2 cursor-pointer bg-none  border border-gray-300 rounded-md px-4 py-2  md:w-[40%] hover:bg-gray-800 transition">
