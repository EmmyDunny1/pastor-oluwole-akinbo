...
const BOOKS: Book[] = [
  ...
  },
  {
    ...
    description:
      "fight for freedom. Prelaunch copies include bonus content and signed inserts. Limited quantities.",
    cover: "/books/Old_Test_Saints.pA billionaire’s cold-blooded plan for revenge collides with a woman’s ng",
    link: "/Books",
    prelaunch: true,
  },
];
