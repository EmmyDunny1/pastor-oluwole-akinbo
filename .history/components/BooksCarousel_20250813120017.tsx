    ...
    <main className="min-h-screen bg-gradient-to-b from-[#171717] to-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-6 py-20">
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
          <div className="lg:mb-[20rem] relative z-10">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <div>
                <div className="font-semibold">Pastor Akinbo</div>
            ...
            <div className="relative w-full max-w-md lg:max-w-xl transform transition-all duration-500 hover:-translate-y-3">
              ...
              <div className="absolute -left-8 -bottom-10 hidden lg:block">
                <div className="bg-[#171717]/70 backdrop-blur-md border border-white/6 rounded-2xl p-4 w-72 shadow-lg -translate-y-6">
                  <div className="text-sm text-pink/90 font-semibold">New Release</div>
                  <div className="mt-1 text-lg font-bold">Old Testament Saints</div>
        ...
        {prelaunch && (
          <section className="mb-10">
            ...
            >
              ...
              />
              <div className="w-full lg:mb-[16rem] lg:w-2/3 z-10 px-3 lg:px-8 py-4 flex flex-col justify-center">
                ...
                <div className="mt-6">
                  <div className="text-sm text-white/80">Author</div>
                  <div className="font-semibold">Pastor S.O Akinbo</div>
                </div>
              </div>
              <div className="w-full lg:w-[45%] z-10 flex flex-col items-center justify-center px-3 py-6">
        ...
        <section className="space-y-10 mb-16">
          {nonPre.map((book) => (
            ...
            >
              <div className="w-full lg:mb-[10rem]  lg:w-2/3 text-left z-10">
              ...
              <div className="w-full lg:w-[75%] flex flex-col items-center">
                <div className="overflow-hidden  transform transition duration-500 group-hover:scale-105">
                  <FallbackImage
                    src={book.cover}
                    alt={book.title}
                    width={520}
                    height={760}
                    className="object-cover h- w-full h-80 rounded-lg"
                  />
                </div>
                <a
                  href={book.link}
                  className="mt-4 inline-flex items-center gap-3 bg-white text-[#171717] font-semibold px-5 py-3 shadow-md hover:shadow-lg transition-all duration-300 group"
                >
                  Order Now
