...
export default function TestimonyForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h2 className="text-2xl font-semibold mb-6 text-center">Share Your Testimony</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          type="submit"
          className="bg-green-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition disabled:opacity-60"
          disabled={uploading}
        >
