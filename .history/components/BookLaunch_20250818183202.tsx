...
const BOOKS: Book[] = [
  ...
  },
  {
    ...
    description: "This book is the first part of the Systematic and Expository Teachings on the Old Testament Saints, beginning from Abraham the Father of  Faith and God’s Friend. ",
