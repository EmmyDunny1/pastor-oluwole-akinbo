    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <label htmlFor="video-upload" className="flex items-center gap-2 cursor-pointer bg-none  border border-gray-300 rounded-md px-4 py-1 w-[47%] md:w-[37%] hover:bg-gray-800 transition">
        ...
        <button className='flex my-[-2px]'>Kindly keep video testimony straight and concise, 2-3 mins</button>
        <button
          type="submit"
