...
const BOOKS: Book[] = [
  ...
  },
  {
    ...
    description: "It is always a good confession to sing Abraham&apos;",
        ...
        >
          ...
          <div className="w-full lg:w-2/3 z-10 px-3 lg:px-8 py-4 flex flex-col justify-center">
            <div className="inline-flex items-center gap-3 mb-3">
              <span className="px-3 py-1 rounded-full text md:text-2xl font-semibold text-white/95 bg-gradient-to-r from-pink-500 to-violet-500 shadow-sm">
