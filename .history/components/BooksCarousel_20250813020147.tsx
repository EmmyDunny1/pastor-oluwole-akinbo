          ...
          <div className="relative z-10">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-white/80">Authorr</div>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="w-full lg:w-2/3 z-10 px-3 lg:px-8 py-4 flex flex-col justify-center">
                <div className="inline-flex items-center gap-3 mb-3">
                  <span className="px-3 py-1 rounded-full text-md font-semibold text-white/95 bg-gradient-to-r from-pink-500 to-violet-500 shadow-sm">
                    PRELAUNCH
                  </span>
