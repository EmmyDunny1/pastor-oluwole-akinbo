...
const books: Book[] = [
  ...
  },
  {
    ...
    author: "The plan of God from the beginning is that each family would be in peace, beacause this is what will ensure the fulfilment of God's plan on earth. Marriage started in the garden of Eden. God the creator of all thingd, the one who",
