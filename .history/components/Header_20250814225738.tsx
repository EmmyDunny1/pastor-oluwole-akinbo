      ...
      <AnimatePresence>
        {isOpen && (
          <motion.nav
            ...
            className="md:hidden bg-white min-h-screen dark:bg-gray-800 border-t border-green-500 dark:border-gr-700 px-4 py-4 space-y-4 text-base font-medium text-left"
          >
            {navLinks.map(({ href, label }) => (
              <Link
                key={href}
