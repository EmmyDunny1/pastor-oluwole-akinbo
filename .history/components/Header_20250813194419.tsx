...
const navLinks = [
  ...
  { href: "/PreOrderPayment", label: "Pre-Order" },
  { href: "/BookLaunch", label: "Book Launch" },
        ...
        <nav className="hidden md:flex gap-6 text-md  items-center font-medium">
          {navLinks.map(({ href, label }) => (
            <Link
              ...
              className={`${
                pathname === href
                  ? "text-gray-600 border-b-2 decoration-0  border-gray-600"
                  : "hover:text-white transition"
              } ${
                label === "Gift"
                  ? "bg-gray-100 text-gray-950 px-4 py-2 rounded-md hover:bg-gray-500  transition"
                  : ""
              }`}
            >
              {label}
            ...
            {navLinks.map(({ href, label }) => (
              <Link
                ...
                className={`block w-full ${
                  ...
                  label === "Gift"
                    ? "bg-gray-800 text-gray-100 px-4 py-2 rounded-md hover:bg-gray-100  border-1 border-white transition"
                    : ""
                }`}
              >
                {label}
