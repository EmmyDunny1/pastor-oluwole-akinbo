...
export default function GiftAccountCard() {
  ...
  const accountNumber = "9301438311";
      ...
      <div className="space-y-6 pt-6 px-6 pb-8">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-center">
          ...
          <p className="text-gray-800 font-medium">
            Bank: <span className="text-yellow-700">Stanbic-ibtc</span>
          </p>
          <p className="text-gray-800 font-medium">
            Account Name: <span className="text-yellow-700">Samuel Oluwole Akinbo</span>
          </p>
